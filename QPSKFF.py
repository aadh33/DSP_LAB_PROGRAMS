...
mod_00 = cosineWave(fc, overSamplingRate, fc/fm, pi/2) 
mod_01 = cosineWave(fc, overSamplingRate, fc/fm, pi) 
mod_10 = cosineWave(fc, overSamplingRate, fc/fm, -pi/2) 
mod_11 = cosineWave(fc, overSamplingRate, fc/fm, -pi) 
modulated_signal = [] 
for i in message: 
    if i == '00': 
